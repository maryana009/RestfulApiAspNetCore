...
namespace Library.API.Services
{
    public class LibraryRepository : ILibraryRepository
    {
        ...
        public IEnumerable<Author> GetAuthorsEnumareble(AuthorsResourceParameters authorsResourceParameters)
        {
        ...
        public PagedList<Author> GetAuthors(AuthorsResourceParameters authorsResourceParameters)
        {
            ...
            return PagedList<Author>
                .Create(collectionBeforePaging, authorsResourceParameters.PageNumber, authorsResourceParameters.PageSize);
        }
